...
public class Jacobi {
    private XYSeries jacobiSeries = new XYSeries("Jacobi");
    
    Jacobi(XYSeriesCollection dataset) {
        dataset.addSeries(jacobiSeries);
    }
    ...
    public void printSolution(double x, double y, double z, int k) {    
        ...
        System.out.println("\ty = [-5 - " + "2(" + x + ") - 3(" + z + ")] / 8 = " + new_y);
        System.out.println("\tz = [-53 - 3(" + x + ") - 2(" + y + ")] / -9 = " + new_z);
        ...
        //Add values to jacobi series
        jacobiSeries.add(k, e);
